...
class landUseController extends mainModel
{
	...
	public function __construct()
	{
		...
		$nom_controlador = "landUseController";
		// ____________________________________________________________________

		$this->log_path = APP_R_PROY . 'app/logs/landUse/';
    ...
    public function consultar_land_use()
    {
    ...
    {
        try {
            $stmt = "SELECT id_cat_land_use, use_code, name, description, requires_number
                FROM cat_land_use
                ORDER BY name ASC";
            $params = [];
