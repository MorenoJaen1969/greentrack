<?php
    ...
    $ruta_address_clas = RUTA_APP."/address_clas/";

    $encabezadoNew = PROJECT_ROOT . "/app/views/inc/encabezadoNew.php";

    $ruta_retorno = "/address_clas";

    $opcion = "address_clasNew";
?>

<main>
    <p hidden id="$ruta_address_clas"><?php echo $ruta_address_clas;?></p>    
    <p hidden id="$ruta_address_clas_ajax"><?php echo $ruta_address_clas_ajax;?></p>    
    ...
    <div class="form-container">
        <form class="FormularioAjax form-horizontal" id="ingreso_address_clas" name="ingreso_address_clas" action="<?php echo $ruta_address_clas_ajax; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
            <input type="hidden" name="modulo_address_clas" value="registrar_address_clas">
                ...
                <div class="forma01">
                    ...
                    <div class="form-group-ct-inline">
                        <div class="form-group-ct">
                            <label class="ancho_label1" for="nombre">Address Classification Identification:</label>
                            <input type="text" id="address_clas" name="address_clas" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <button type="submit" class="btn-submit" id="submitBtn">
                Register Address Classification
            </button>                
        </form>
    </div>
...
<script type="text/javascript">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const address_clas = document.getElementById('address_clas');
