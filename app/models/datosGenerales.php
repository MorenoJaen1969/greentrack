...
class datosGenerales extends mainModel
{
	private $log_path;
	private $logFile;
	...
	public function __construct()
	{
		...
		$nom_controlador = "datosGenerales";
		// ____________________________________________________________________

		$this->log_path = APP_R_PROY . 'app/logs/modelo/datosgenerales/';
	...
	public function datos_para_gps()
	{
        $query = "SELECT valor 
			...
			WHERE clave = :v_clave1 or clave = :v_clave2 OR clave = :v_clave3";
			...
			foreach ($resultado as $row) {
				switch ($van) {
					...
					case 1:
						...
						break;
					case 2:
						$valor = 'umbral_minutos';
						break;
				}

				$config[$valor] = $row['valor'];
				$van ++;
			}
			return $config;
